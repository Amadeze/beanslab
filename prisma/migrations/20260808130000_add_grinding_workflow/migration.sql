-- AlterEnum
ALTER TYPE "GrindSize" ADD VALUE 'WHOLE_BEAN';
ALTER TYPE "GrindSize" ADD VALUE 'COARSE';
ALTER TYPE "GrindSize" ADD VALUE 'MEDIUM_COARSE';
ALTER TYPE "GrindSize" ADD VALUE 'MEDIUM';
ALTER TYPE "GrindSize" ADD VALUE 'MEDIUM_FINE';
ALTER TYPE "GrindSize" ADD VALUE 'FINE';
ALTER TYPE "GrindSize" ADD VALUE 'ESPRESSO';
ALTER TYPE "GrindSize" ADD VALUE 'CUSTOM';
