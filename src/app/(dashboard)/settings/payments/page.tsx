      ...
      <div className="custom-scrollbar flex-1 overflow-auto">
        <div className="mx-auto max-w-5xl p-4 md:p-6 lg:p-8">
          <div className="mb-5 grid gap-3 md:grid-cols-2">
            ...
            <section className="rounded-xl border border-stone-200 bg-white p-4"><p className="text-xs font-bold uppercase tracking-wider text-stone-500">Xendit · tahap berikutnya</p><h2 className="mt-1 text-sm font-black text-stone-900">{xenditConfigured && tenant?.xenditEnabled ? "Adapter siap diuji" : "Belum diaktifkan"}</h2><p className="mt-1 text-xs leading-5 text-stone-600">Aktivasi menunggu akun xenPlatform, sub-account tenant, KYC, webhook, dan uji sandbox. Tidak mengganggu alur manual.</p></section>
          </div>
