...
suite("promoteExperimentalToCatalog", () => {
  ...
  it("converts prototype kilograms into packaged catalog units, a recipe, and a default placement", async () => {
    ...
    const result = await promoteExperimentalToCatalog({ experimentalProductionId: ids.batch, code: "FG-PROMO-250", name: "Promotion 250g", netWeightGrams: 250, packagingSupplyItemId: ids.supply });
